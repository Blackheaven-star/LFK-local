...
<div class='sidebar book'>
	...
	<div class='sidebar__item reward-driven'>
		...
		<div class='sidebar__links'>
			<a href='<?php echo home_url(); ?>/avatar-creation' title='Avatar Dress-Up'>
			...
			<?php if ($quizzesArr) : ?>
				...
				<?php foreach ($quizzesArr as $index => $q) : ?>
					<a 	href='javascript: void(0);' 
						...
						data-book-title='<?php echo get_the_title($passedBookID); ?>'
						data-book-language='<?php echo get_the_title($passedLangID); ?>'
